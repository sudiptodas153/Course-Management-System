...
const Courses = ({ data }) => {
    ...
    return (
        <div className='max-w-11/12 mx-auto'>
            ...
            <p className='text-center dark:text-white text-gray-500 mt-3 md:px-20'>Discover our latest course offerings designed to sharpen your skills and expand your knowledge.Stay updated with the newest additions — carefully curated for learners of all levels.</p>
            <div className='grid grid-cols-1  md:grid-cols-4 md:gap-5'>
                {
                    data.map(course =>
                        <div className='md:relative' key={course._id}>

                            <div className="p-5 bg-gradient-to-b from-[#f50505] to-[#ee0707]  mt-5 rounded-lg md:w-72 h-60 md:h-96 shadow-sm"
                                style={{
                            ...
                            >
                                ...
                                <div className="mt-16 md:absolute md:bottom-7">
