                                ...
                                <div className="mt-3 ">
                                    ...
                                    <div className="px-4">
                                        <Link to={`/courses/${course._id}`}>
                                            <button className="btn border-1 text-emerald-500 border-emerald-400 hover:text-white text-lg font-semibold hover:border-none hover:bg-emerald-400 w-full">Details</button>
                                        </Link>
                                    </div>
                                </div>
                            </div>
