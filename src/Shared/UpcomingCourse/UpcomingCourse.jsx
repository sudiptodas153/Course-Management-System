...
const UpcomingCourse = () => {
    ...
    return (
        <div className=' max-w-11/12 mx-auto'>
            ...
            <p className='text-center dark:text-white text-gray-500 mt-3 md:px-20'>Stay ahead with our upcoming courses – carefully crafted to match future trends and skills in demand.Get ready to explore what’s coming next and be the first to enroll!</p>
